...
class DependencyScorerI(object):
    ...
    def train(self, graphs):
        ...
        :param graphs: A list of dependency figures to train the scorer.
        Typically the edges present in the figures can be used as
...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> figures = [DependencyGraph(entry) for entry in conll_data2.split('\\n\\n') if entry]
    >>> npp = ProbabilisticNonprojectiveParser()
    >>> npp.train(figures, NaiveBayesDependencyScorer())
    ...
    def train(self, graphs):
        ...
        figures list as positive examples, the edges not present as
